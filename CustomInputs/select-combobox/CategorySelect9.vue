...
onMounted(() => {
    if (slots.default) {
        ...
        dynamicCategories.value = children
            ...
            .map((vnode) => ({
                id: String(vnode.props!.id), // Wymuszamy typ String dla spójności
...
// POPRAWKA: Rzutowanie porównywanych ID na String, aby Vue widziało zaznaczenia
...
<template>
    <div class="comp-container" style="max-width: 400px; margin: 20px auto; font-family: sans-serif">
        <div ref="containerRef" class="w-full max-w-sm rounded-lg border-2 border-blue-500 p-4 font-sans outline-none">
            <div class="hidden">
                <slot />
            </div>
