...
// Funkcja zamykająca listę po kliknięciu poza komponentem
...
const toggleCategory = (category: Category): void => {
    ...
    // UWAGA: Nie czyścimy już searchQuery ani focusedIndex,
    // aby użytkownik mógł dalej wygodnie klikać pozycje bez resetu listy
};
